...
class NotificationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.CreateOrderNotification = channel.unary_unary(
...
class NotificationServiceServicer(object):
    ...
    def CreateOrderNotification(self, request, context):
        """Missing associated documentation comment in .proto file."""
...
def add_NotificationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'CreateOrderNotification': grpc.unary_unary_rpc_method_handler(
                    servicer.CreateOrderNotification,
...
class NotificationService(object):
    ...
    @staticmethod
    def CreateOrderNotification(request,
            target,
            options=(),
        ...
        return grpc.experimental.unary_unary(
            ...
            notification__pb2.NotificationReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
